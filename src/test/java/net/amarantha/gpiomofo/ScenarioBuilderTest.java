...
import net.amarantha.gpiomofo.core.target.HttpTarget;
import net.amarantha.gpiomofo.core.target.MidiTarget;
import net.amarantha.gpiomofo.core.target.OscTarget;
import net.amarantha.gpiomofo.core.target.Target;
import net.amarantha.gpiomofo.core.trigger.CompositeTrigger;
import net.amarantha.gpiomofo.core.trigger.HttpTrigger;
import net.amarantha.gpiomofo.core.trigger.OscTrigger;
