...
public abstract class Spryte {
    ...
    @Inject
    protected LightSurface surface;
    ...
    public double distanceTo(Spryte other) {
    ...
    public Spryte setLinearDelta(double dX, double dY) {
    ...
    public Spryte setLayer(int layer) {
        this.layer = layer;
        return this;
    }

    public Spryte setColour(RGB colour) {
        this.colour = colour;
        return this;
    }
