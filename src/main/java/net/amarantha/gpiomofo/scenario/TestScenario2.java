...
//        Target p2 = targets.python("python/strandtest.py chase-red");
//        Target p3 = targets.python("python/strandtest.py chase-blue");

        sensor
            .addRange(0.0, 0.3, targets.chain().add(0, t1).build())
            .addRange(0.3, 0.7, targets.chain().add(0, t2).build())
            .addRange(0.7, 1.0, targets.chain().add(0, t3).build())
        ;
